...
#' \item{\code{For_Analysis}:}{Object of class \code{"logic"}. Are this experiment valid for final analysis? default to `TRUE` since this dataset already exclude no working experiment.}
#' \item{\code{log.Cyto_tau}:}{Object of class \code{"double"}. Logarithmic transformation (base 10) of the Decay time constant calculated from the descending phase of deskewed wave. Units are in ms.}
#' \item{\code{log.Cyto_DFF0}:}{Object of class \code{"double"}. Logarithmic transformation (base 10) of the Amplitude of deskewed waves. Units are in DF/F0.}
#' \item{\code{log.Cyto_Wave_Speed}:}{Object of class \code{"double"}. Logarithmic transformation (base 10) of the Velocity of Ca wave propagation. Units are in µm/s.}
#' \item{\code{log.Freq_waves_Hz}:}{Object of class \code{"double"}. Logarithmic transformation (base 10) of the Frequency of waves observed in a Linescan. Units are in Hz.}
#' }
#'
#'
